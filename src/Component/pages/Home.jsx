...
export default function Home() {
  const [data, setData] = useState([]);
    ...
    function fetchData() {
      fetch(`http://localhost:3000/books?_limit=8`)
        .then( (res) => {
          return res.json();
        })
        .then((data) =>
  ...
  return (
    ...
    <div className="mt-20">
        <h1 className='text-center text-black text-3xl font-bold'>Latest Books</h1>
    </div>

    {/* Books */}
    <section className='h-auto flex justify-center flex-wrap gap-16 mt-10'>  
    {
      data?.map(it => (
        <Cards key={it.key} BookName={it.BookName} bookRating={it.bookRating} image={it.image} price={it.price} yearOfPublishing={it.yearOfPublishing} isAddedToCart={it.isAddedToCart} id={it.key} />
      ))
    }
    </section>
    ...
    <div className='mt-20'>
        <div className="mt-10 flex justify-center">
          <Link to="/products" className='bg-black text-white py-4 px-10 rounded-lg border-2 hover:bg-white hover:text-black hover:border-2 hover:border-black'>Show More</Link>
        </div>
    </div>
    <section>
        <div className="flex justify-center items-center my-20">
          <div className="lg:w-[1300px]  mr-6  bg-white rounded-lg flex flex-col gap-6 justify-center items-center   ">
            <p className="text-black contentfont self-center text-[22px] font-bold  mt-3">Shop By Publishers</p>
            <marquee scrollamount="10">
              <div className="flex gap-10  pb-10">
                <img src="src/assets/images/items-1.jpg" className="h-28"></img>
                <img src="src/assets/images/items-2.jpg" className="h-28"></img>
                <img src="src/assets/images/items-3.jpg" className="h-28"></img>
                <img src="src/assets/images/items-4.jpg" className="h-28"></img>
                <img src="src/assets/images/items-5.jpg" className="h-28"></img>
                <img src="src/assets/images/items-1.jpg" className="h-28"></img>
                <img src="src/assets/images/items-2.jpg" className="h-28"></img>
                <img src="src/assets/images/items-3.jpg" className="h-28"></img>
                <img src="src/assets/images/items-4.jpg" className="h-28"></img>
  ...
  <section className="my-5">
        <div class="flex items-center justify-center flex-col lg:flex-row border-t border-b w-full border-[#000] py-10">
 ...
 4.1c3.2 5.3 8.83 10.5 17.07 15.1c13.63 7.7 33.63 12.9 55.83 12.9c10.1 0 19.7-1.1 28.5-3v-20.8c13.8-2.1 25.4-5.9 32.8-10.8v18.4c10-7 14.8-14.9 14.8-22.4c0-8.7-6.5-18-20.2-25.7c-7.4-4.1-16.6-7.5-26.9-9.8"
          ...
          <div class="flex items-center space-x-2">
            ...
            <span className='text-black'>Verified Products</span>
          </div>
          <div class="h-6 w-px bg-gray-300 mx-4"></div>
          <div class="flex items-center space-x-2">
            <svg
  ...
  1 0 0 1-1.497-1.32l.083-.094L8.584 19H5a3 3 0 0 1-2.995-2.824L2 16v-3a1 1 0 0 1 1-1"
            ...
            <span className='text-black'>Easy Replacement</span>
          </div>
        </div>
      </section>
      <section className='mt-32 p-4'>
        <img className='w-full' src="src/assets/images/add-img-1.jpeg" alt="" />
        <div className="flex justify-between flex-wrap mt-4">
          <img className='w-auto h-[300px]' src="src/assets/images/add-img-2.jpeg" alt="" />
          <img className='w-auto h-[300px]' src="src/assets/images/add-img-3.jpeg" alt="" />
          <img className='w-auto h-[300px]' src="src/assets/images/add-img-2.jpeg" alt="" />
          <img className='w-auto h-[300px]' src="src/assets/images/add-img-3.jpeg" alt="" />
        </div>
      </section>
